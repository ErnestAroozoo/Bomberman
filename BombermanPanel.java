...
public class BombermanPanel extends JPanel{
  ...
  public static void bombdisplay_yellow(Graphics g){
	...
	public static void bombexplosion(Graphics g){
		...
		if(blnbomb1set){
			...
			if(inttime >= 3){
				bombposition(intBombX_blue,intBombY_blue,intbombrange_blue,g); // bomb explosion
				 if(intX >= intBombX_blue - (180 *intbombrange_blue)  && intX <= (intBombX_blue + 180* intbombrange_blue) && intY >= intBombY_blue - (180 * intbombrange_blue) && intY <= (intBombY_blue +180* intbombrange_blue)){
        Bomberman.blnDeathBlue = true;
          g.drawString("My children are fertile",100,100);
        }
        if(intBombX_blue == intX_yellow && intBombY_blue == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBombX_blue == intX_red && intBombY_blue == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBombX_blue == intX_white && intBombY_blue == intY_white ){
        ...
        if(intBomb2X_blue == intX && intBomb2Y_blue == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBomb2X_blue == intX_yellow && intBomb2Y_blue == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBomb2X_blue == intX_red && intBomb2Y_blue == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBomb2X_blue == intX_white && intBomb2Y_blue == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
		...
		if(blnbomb3set){
			...
			if(inttime >= 3){
				...
				if(intBomb3X_blue == intX && intBomb3Y_blue == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBomb3X_blue == intX_yellow && intBomb3Y_blue == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBomb3X_blue == intX_red && intBomb3Y_blue == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBomb3X_blue == intX_white && intBomb3Y_blue == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
        ...
        if(intBomb4X_blue == intX && intBomb4Y_blue == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBomb4X_blue == intX_yellow && intBomb4Y_blue == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBomb4X_blue == intX_red && intBomb4Y_blue == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBomb4X_blue == intX_white && intBomb4Y_blue == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
	...
	public static void bombexplosion_red(Graphics g){
		...
		if(blnbomb1set_red){
			...
			if(inttime >= 3){
				...
				if(intBombX_red == intX && intBombY_red == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBombX_red == intX_yellow && intBombY_red == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBombX_red == intX_red && intBombY_red == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBombX_red == intX_white && intBombY_red == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
				bomb1duration_red = 0;
        ...
        if(intBomb2X_red == intX && intBomb2Y_red == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBomb2X_red == intX_yellow && intBomb2Y_red == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBomb2X_red == intX_red && intBomb2Y_red == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBomb2X_red == intX_white && intBomb2Y_red == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
				bomb2duration_red = 0;
		...
		if(blnbomb3set_red){
			...
			if(inttime >= 3){
				...
				if(intBomb3X_red == intX && intBomb3Y_red == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBomb3X_red == intX_yellow && intBomb3Y_red == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBomb3X_red == intX_red && intBomb3Y_red == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBomb3X_red == intX_white && intBomb3Y_red == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
				bomb3duration_red = 0;
        ...
        if(intBomb4X_red == intX && intBomb4Y_red == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBomb4X_red == intX_yellow && intBomb4Y_red == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBomb4X_red == intX_red && intBomb4Y_red == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBomb4X_red == intX_white && intBomb4Y_red == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
				bomb4duration_red = 0;
	...
	public static void bombexplosion_yellow(Graphics g){
		...
		if(blnbomb1set_yellow){
			...
			if(inttime >= 3){
				...
				if(intBombX_yellow == intX && intBombY_yellow == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBombX_yellow == intX_yellow && intBombY_yellow == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBombX_yellow == intX_red && intBombY_yellow == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBombX_yellow == intX_white && intBombY_yellow == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
        ...
        if(intBomb2X_yellow == intX && intBomb2Y_yellow == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBomb2X_yellow == intX_yellow && intBomb2Y_yellow == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBomb2X_yellow == intX_red && intBomb2Y_yellow == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBomb2X_yellow == intX_white && intBomb2Y_yellow == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
		...
		if(blnbomb3set_yellow){
			...
			if(inttime >= 3){
				...
				if(intBomb3X_yellow == intX && intBomb3Y_yellow == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBomb3X_yellow == intX_yellow && intBomb3Y_yellow == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBomb3X_yellow == intX_red && intBomb3Y_yellow == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBomb3X_yellow == intX_white && intBomb3Y_yellow == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
        ...
        if(intBomb4X_yellow == intX && intBomb4Y_yellow == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBomb4X_yellow == intX_yellow && intBomb4Y_yellow == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBomb4X_yellow == intX_red && intBomb4Y_yellow == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBomb4X_yellow == intX_white && intBomb4Y_yellow == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
  ...
  public static void bombexplosion_white(Graphics g){
		...
		if(blnbomb1set_white){
			...
			if(inttime >= 3){
				...
				if(intBombX_white == intX && intBombY_white == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBombX_white == intX_yellow && intBombY_white == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBombX_white == intX_red && intBombY_white == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBombX_white == intX_white && intBombY_white == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
        ...
        if(intBomb2X_white == intX && intBomb2Y_white == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBomb2X_white == intX_yellow && intBomb2Y_white == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBomb2X_white == intX_red && intBomb2Y_white == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBomb2X_white == intX_white && intBomb2Y_white == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
		...
		if(blnbomb3set_white){
			...
			if(inttime >= 3){
				...
				if(intBomb3X_white == intX && intBomb3Y_white == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBomb3X_white == intX_yellow && intBomb3Y_white == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBomb3X_white == intX_red && intBomb3Y_white == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBomb3X_white == intX_white && intBomb3Y_white == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
        ...
        if(intBomb4X_white == intX && intBomb4Y_white == intY){
        Bomberman.blnDeathBlue = true;
        }
        if(intBomb4X_white == intX_yellow && intBomb4Y_white == intY_yellow ){
        Bomberman.blnDeathYellow = true;
        }
        if(intBomb4X_white == intX_red && intBomb4Y_white == intY_red ){
        Bomberman.blnDeathRed = true;
        }
        if(intBomb4X_white == intX_white && intBomb4Y_white == intY_white ){
        Bomberman.blnDeathWhite = true;
        }
				if(inttime > 6){
 ...
 * *******************************************************************/
    ...
    int intCount2 = 0;
      ...
      g.drawString(""+Bomberman.intScoreBlue, 400, 700);
      g.drawString(""+Bomberman.intScoreBlue, 642, 700);
      g.drawString(""+Bomberman.intScoreBlue, 884, 700);
			// Bomberman Animation
